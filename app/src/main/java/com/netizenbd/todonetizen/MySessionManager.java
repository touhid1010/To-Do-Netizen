...
public class MySessionManager {
    ...
    public void checkLogin() {
        // Check login status
        if (!this.isLoggedIn()) {
            // user is not logged in redirect him to Login Activity (here MainActivity is login activity)
    ...
    public void logoutUser() {
        ...
        // After logout redirect user to Loing Activity (here MainActivity is login activity)
        Intent i = new Intent(_context, MainActivity.class);
        // Closing all the Activities
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
